...
*/
function HaberYapici(haberObjesi) {
  ...
  h2.textContent = haberObjesi.baslik;
  tarih.textContent = haberObjesi.tarih;
  p1.textContent = haberObjesi.ilkParagraf;
  p2.textContent = haberObjesi.ikinciParagraf;
  p3.textContent = haberObjesi.ucuncuParagraf;
  buton.textContent = '+';
...
data.forEach((haberItem) => {
  articlesContainer.appendChild(HaberYapici(haberItem));
});
